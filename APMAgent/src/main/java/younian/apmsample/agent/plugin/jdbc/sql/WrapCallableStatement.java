...
public class WrapCallableStatement implements CallableStatement {

	private Connection realConnection;
	private CallableStatement realStatement;
	private String sql;

	public WrapCallableStatement(Connection realConnection,
	...
	public int executeUpdate(String sql, final int autoGeneratedKeys) throws SQLException {
		return ConnectionTracing.execute(realConnection, "executeUpdate", sql, new Executable<Integer>() {
	...
	public ResultSet executeQuery() throws SQLException {
		return ConnectionTracing.execute(realConnection, "executeQuery", sql, new Executable<ResultSet>() {
